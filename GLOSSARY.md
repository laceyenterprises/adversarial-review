...
| **ACPX** | A local "agent client protocol" runtime used as one of the reviewer-process spawn shapes. Optional; the default reviewer runtime is `cli-direct`. | `.acpxrc.json`, `tools/adversarial-review/DEPS.md`. |
