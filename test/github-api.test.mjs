...
export async function load(url, context, nextLoad) {
  ...
  const simpleStubs = {
    ...
    'fixture:reviewer-pass-tokens': "export function beginReviewerPass() { return { ok: true }; } export function completeReviewerPass() { return { ok: true }; } export function reviewerPassRows() { return []; } export function readBestReviewerEvidenceTokenUsage() { return null; } export function readWorkerRunTokenUsageResult() { return { ok: false, reason: 'missing-worker-run-row' }; } export function tagTokenUsage(tokenUsage) { return tokenUsage || null; } export function writeReviewerTokenUsageArtifact() { return null; }",
