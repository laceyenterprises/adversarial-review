...
export async function load(url, context, nextLoad) {
  ...
  const simpleStubs = {
    ...
    'fixture:watcher-reviewer-pool': "export function compareReviewerDispatchCandidates() { return 0; } export function countActiveReviewerSpawnsByModel() { return new Map(); } export function createDetachedReviewerDispatchTracker() { return { activeCounts: () => new Map(), track: () => {} }; } export function createReviewerMemoryAdmissionSampler() { return { sample: async () => ({ admit: true }) }; } export function reserveReviewerMemoryAdmission() { return () => {}; } export async function fetchGeminiCredentialConcurrency() { return null; } export function resolveFirstPassReviewerPoolConfig() { return { enabled: false }; } export function resolveReviewerMemoryPressureConfig() { return {}; } export async function runBoundedReviewerDispatchQueue() { return { dispatched: 0, skipped: 0 }; } export function sortReviewerDispatchCandidates(items) { return items; }",
