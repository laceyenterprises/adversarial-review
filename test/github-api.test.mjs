...
export async function load(url, context, nextLoad) {
  ...
  const simpleStubs = {
    ...
    'fixture:role-registry': "export function validateStartupRoleRegistry() {} export function loadRoleRegistry() { return { roles: {}, routing: { neverReviewOwnBuilderClass: true } }; }",
    ...
    'fixture:follow-up-jobs': "export function createFollowUpJob() { return { jobPath: '/tmp/github-api-fixture-follow-up-job.json' }; } export function markFollowUpJobCompleted() { return { status: 'completed' }; } export function resolveRoundBudgetForJob() { return { roundBudget: 1, riskClass: 'medium' }; } export function summarizePRRemediationLedger() { return { completedRoundsForPR: 0, latestRiskClass: 'medium', latestMaxRounds: 1 }; } export function isActiveFollowUpJobStatus() { return false; }",
