...
| `review:remediation_zero_throughput` | one or more remediation jobs are pending while `follow-up-jobs/in-progress` is empty | ticket | a remediation job enters progress or the pending queue drains |
